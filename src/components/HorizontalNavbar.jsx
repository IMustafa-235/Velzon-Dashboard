...
const HorizontalNavbar = ({ toggleFullScreen, toggleTheme, themeSwitch }) => {
  ...
  return (
    <div>
      <nav
        className="d-lg-block sticky-top w-100 z-3 d-none lg-nav shadow-sm"
        style={{ top: "10px" }}
      >
        <div className="d-flex  flex-column">
       <div className=" horizontal-nav-border-bottom">
       <div
            className="d-flex container
             justify-content-between align-items-center flex-column flex-lg-row "
          >
            <div className="d-flex  align-items-center gap-5 nav-first-child px-4">
              <div className={`${themeSwitch? "d-none" : "d-block"}`}>
                <Link to={"/"}><img src={blackLogo} width={100} alt="" /></Link>
              </div>
              <div className={`${themeSwitch? "d-block" : "d-none"}`}>
            ...
            <div className="d-flex align-items-center gap-3 px-4">
              ...
              <div
                ...
                className="d-flex align-items-center gap-2 r-c-1 py-3"
          ...
          <div
            className="d-flex container align-items-center gap-4 px-4 py-3 flex-wrap"
            style={{ color: "#8b8d9a" }}
          >
            <div className="d-flex align-items-center" style={{ gap: "10px" }}>
              <RiDashboard2Line size={19} style={{ strokeWidth: 0.5 }} />
            ...
            <div className="d-flex align-items-center" style={{ gap: "10px" }}>
              <CiGrid41 size={20} style={{ strokeWidth: 1 }} />
              <p className="mb-0" style={{ fontSize: "14.5px" }}>
                App
              </p>
              <MdKeyboardArrowDown />
            ...
            <div className="d-flex align-items-center" style={{ gap: "10px" }}>
              <FiLayout size={18} style={{ strokeWidth: 2 }} />
              <p className="mb-0" style={{ fontSize: "14.5px" }}>
                Layout
              </p>
              <MdKeyboardArrowDown />
        ...
        <div className={`${flagBox ? "d-block" : "d-none"}`}>
          <div className="flag-box horizontal-nav-flagbox rounded-3 d-flex flex-column justify-content-center py-3 shadow-sm z-3 foa map-text">
            {flags_data.map((item) => {
              return (
                <div
                  key={item.id}
        ...
        <div className={`${appBox ? "d-block" : "d-none"}`}>
          <div className="shadow app-box horizontal-nav-appbox py-3 rounded-2 z-3 foa">
        ...
        <div className={`cart-abso ${navCart ? "d-block" : "d-none"}`}>
          <div className="d-flex justify-content-center align-items-center foa horizontal-nav-cartbox">
        ...
        <div
          className={`notification-abso horizontal-nav-notificationbox ${
        ...
        <div className={`${profileBox ? "d-block" : "d-none"}`}>
          <div className="profile-box horizontal-nav-profilebox py-3 shadow rounded-3">
            <p
              className="px-3"
              style={{
                color: "#9194a1",
