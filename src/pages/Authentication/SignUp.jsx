    ...
    <>
      <div className="signIn-wrapper">
        <div className="d-flex justify-content-center align-items-center py-lg-5">
          <div className="signin-card-signup">
            ...
            <div className="col-12 col-lg-6 form-section position-relative">
              ...
              <div className="mb-3">
              <label style={{ fontSize: "13px" }}>Email <span style={{fontStyle:"italic", color:"#f06f59"}}>*</span></label>
              ...
              <div className="mb-3">
                <label style={{ fontSize: "13px" }}>Username <span style={{fontStyle:"italic", color:"#f06f59"}}>*</span></label>
                <input className="sign-form-input"
                  style={{ fontSize: "13px" }}
                  type="text"
              ...
              <div className="remember">
                <p className="mb-0" style={{fontSize:"12px", color:"#8f939f"}}><span style={{fontStyle:"italic"}}>By registering you agree to the Velzon</span><span style={{color:"#405189", cursor:"pointer", textDecoration:"underline", marginLeft:"4px"}}>Terms of Use</span></p> 
              </div>
              ...
              <div className="social-wrapper d-flex align-items-center justify-content-center gap-4">
                ...
                <p className="mb-0" style={{ fontSize: "13px", color:"#878a99" }}>
                  Create account with
                </p>
                <div className="line-signup"></div>
              </div>
        ...
        <footer className="footer">
          © 2026 Velzon. Crafted with by <FaHeart color="#f06548"/> Muhammad Mustafa
        </footer>
      </div>
    </>
  );
